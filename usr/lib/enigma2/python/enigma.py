...
class eMediaDatabase(object):
    ...
    def getVideos(self, *args):
        """
        getVideos(eMediaDatabase self, std::string const & dir, StringList tags=std::list< std::string >(), int limit=-1, 
            int offset=0) -> eMediaDatabaseResultPtr
        getVideos(eMediaDatabase self, std::string const & dir, StringList tags=std::list< std::string >(), int limit=-1) -> eMediaDatabaseResultPtr
        getVideos(eMediaDatabase self, std::string const & dir, StringList tags=std::list< std::string >()) -> eMediaDatabaseResultPtr
    ...
    def getRecordTags(self, *args):
        """getRecordTags(eMediaDatabase self, int file_id) -> eMediaDatabaseResultPtr"""
        return _enigma.eMediaDatabase_getRecordTags(self, *args)

    def setRecordTags(self, *args):
        """setRecordTags(eMediaDatabase self, int file_id, StringVector tags) -> eMediaDatabaseResultPtr"""
        return _enigma.eMediaDatabase_setRecordTags(self, *args)
